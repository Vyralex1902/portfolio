    ...
    return (
      ...
      rounded-md text-center items-center align-middle">
       ...
       text-gray-300 rounded-md">
        ...
        <div id="freelancingSectionDiv" className="z-10 mt-10 mb-10 flex flex-col justify-center items-center align-top w-[40vw] bg-white bg-opacity-10
      backdrop-blur-md p-3 text-gray-300 rounded-lg">
        ...
        <div id="freelancingSectionDiv" className="z-10 mb-20 flex flex-col justify-center items-center align-top w-[40vw] bg-white bg-opacity-10
      backdrop-blur-md p-3 text-gray-300 rounded-lg">
              ...
              <div className='w-fit'>
                <Link to="donate" className="cursor-context-menu">
                  <div className="downloadbtn_div">
                    <motion.button className="downloadbtn" whileHover={{ scale: 1.07 }} whileTap={{ scale: 0.8 }}>
                      <div className='flex flex-col justify-center items-center'>
                        <p className="text-blue-600">Donate</p>
                      </div>
                    </motion.button>
                  </div>
                </Link>
